...
const setupDatabase = async () => {
  try {
    ...
    // Di dalam src/database/setup.js
await query(`DROP TABLE IF EXISTS food_proposals CASCADE`);

await query(`
  CREATE TABLE IF NOT EXISTS food_proposals (
    proposal_id SERIAL PRIMARY KEY,
    proposed_food_name VARCHAR(255) NOT NULL,
    proposed_calories NUMERIC NOT NULL DEFAULT 0,
